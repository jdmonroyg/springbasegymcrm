...
class TrainerControllerTest {
    ...
    void getTrainerByUsername() throws Exception {
        ...
        when(trainerService.selectTrainerByUsername(token, username))
                .thenReturn(responseDto);
    ...
    void updateTrainer() throws Exception {
        ...
        when(trainerService.updateTrainer(eq(token), any(UpdateTrainerRequestDto.class)))
        ...
        mockMvc.perform(put("/trainers")
                ...
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.username").value("Carlos.Perez"))
    ...
    void changeActiveStatus() throws Exception {
        ...
        doNothing().when(trainerService)
                .changeActiveStatus(eq(token), any(PatchUserRequestDto.class));
    ...
    void getTrainerTrainingsByUsername() throws Exception {
        ...
        when(trainerService.getTrainerTrainings(eq(token), eq(username), any(TrainerTrainingsFilterRequestDto.class)))
    ...
    void getUnassignedActiveTrainers() throws Exception {
        ...
        when(trainerService.getUnassignedTrainersByTraineeUsername(token, traineeUsername))
