...
class TraineeControllerTest {
    ...
    void getTraineeByUsername_success() throws Exception {
        ...
        when(traineeService.selectTraineeByUsername("Juan.Monroy"))
                .thenReturn(respDto);
    ...
    void deleteTrainee_success() throws Exception {
        String token = getToken();
        doNothing().when(traineeService).deleteTrainee( "Juan.Monroy");
    ...
    void updateTrainee() throws Exception {
        ...
        when(traineeService.updateTrainee("Jesus.Monroy",req)).thenReturn(resp);
    ...
    void changeActiveStatus() throws Exception {
        ...
        String body = """
            ...
            """;
        doNothing().when(traineeService).changeActiveStatus("Jesus.Monroy", req);
    ...
    void getTraineeByUsername() throws Exception {
        ...
        when(traineeService.getTraineeTrainings(eq(username),
