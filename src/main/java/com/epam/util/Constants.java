...
public class Constants {
    ...
    public static final String INVALID_MAX_VALUE = "The maximum value of the field is 120";
    ...
    public static final String INVALID_FUTURE_DATE = "Training date must be in the future";
